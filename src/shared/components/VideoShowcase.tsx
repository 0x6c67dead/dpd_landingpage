  ...
  return (
    <section className="relative w-full h-[60vh] md:h-[80vh] overflow-hidden flex items-center justify-center">
      ...
      <video
        ...
        poster="https://images.unsplash.com/photo-1508807526345-15e9b5f4eaff?q=80&w=1200&auto=format&fit=crop"
      >
        {/* Generic dance video from Pexels (royalty free) */}
        <source
          src="https://videos.pexels.com/video-files/4922984/4922984-uhd_2560_1440_24fps.mp4"
          type="video/mp4"
        />
      </video>
